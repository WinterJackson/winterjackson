import { BadgeCheck, Briefcase, Building, Code, GraduationCap, LayoutDashboard, Mail, MessageSquare, Settings, User, UserCheck, Users, Zap } from 'lucide-react'
...
export const adminNavItems = [
    ...
    { name: 'Certifications', path: '/admin/certifications', icon: BadgeCheck, color: '#0ea5e9' }, // Sky
    { name: 'Referees', path: '/admin/referees', icon: UserCheck, color: '#f97316' }, // Orange
